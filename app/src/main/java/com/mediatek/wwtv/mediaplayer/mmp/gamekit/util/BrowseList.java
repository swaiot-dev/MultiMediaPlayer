package com.mediatek.wwtv.mediaplayer.mmp.gamekit.util;
...
public class BrowseList {
	...
	public FileAdapter getNext(){
		...
		MtkLog.d(TAG, " getNext num = " + mNum + "mcurIdx =" + mCurHeadIdx);
		...
		MtkLog.d(TAG, "getNext mcurIdx =" + mCurHeadIdx);
...
/*	public FileAdapter getPhysicalNext(){
	...
	public FileAdapter getPre(){
		mNum = mForeFileList.size();
		MtkLog.d("MtkMainActivity.java", " getPre num = " + mNum + "mcurIdx =" + mCurHeadIdx);
		//if (mNum <= BORAD_NUM) return null;
		...
		mGetMode = PRE;
		MtkLog.d("MtkMainActivity.java", " getPre mcurIdx =" + mCurHeadIdx);
		return mForeFileList.get(mCurHeadIdx);
	}

	public int getNum(){
		mNum = mForeFileList.size();
		MtkLog.d(TAG, "getNum....filelist size = " + mNum);
		return mNum;
	}
