...
public class ConstPhoto {
	...
	public static final int PHOTO_FRAME_ONE = 1;
	public static final int PHOTO_FRAME_DEV = 2;
    ...
    public static final int PLAYTOEND = 101;
    ...
    public static final int MOVE_RIGHT = 28;
    public static final int MOVE_LEFT = 29;
    public static final int MOVE_UP = 30;
    public static final int MOVE_DOWN = 31;
	...
	public static final String TempFolderPath = "/tmp/mtk";
