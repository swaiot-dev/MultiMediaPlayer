...
public class PlayList implements IPlayList {
  ...
  // music play list
  private final ArrayList<String> backFileList;

  // music shuffle list
  private final ArrayList<String> backShuffleFileList;

  // video play list
  private final ArrayList<String> foreVideoFileList;

  // video shuffle list
  private final ArrayList<String> foreShuffleVideoFileList;

  // image text play list
  private final ArrayList<String> foreFileList;

  // image text shuffle list
  private final ArrayList<String> foreShuffleFileList;

  private final ArrayList<Boolean> markFileList;
