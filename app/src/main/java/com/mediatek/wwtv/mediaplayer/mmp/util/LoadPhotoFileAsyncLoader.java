...
public class LoadPhotoFileAsyncLoader<Result> {

    private final ArrayList<WorkItem<Result>> mQueue = new ArrayList<WorkItem<Result>>();

    private static LoadPhotoFileAsyncLoader mAsyncLoader = null;
    ...
    public static LoadPhotoFileAsyncLoader getInstance(int num) {

        if (mAsyncLoader == null) {
            mAsyncLoader = new LoadPhotoFileAsyncLoader("PreFileThread");
        }
        return mAsyncLoader;
    }
    ...
    public LoadPhotoFileAsyncLoader(String name) {
