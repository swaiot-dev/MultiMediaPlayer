...
public class DLNAFile {
  ...
  public String getSuffix() {
    ...
    if (type == TYPE_DEVICE) {
      ...
      MtkLog.i(TAG, "mimeType:" + mimeType + " name:" + getName());
      if (mimeType == null) {
        return "";
      }
      ...
      /* MUSIC */
        ...
        return FileSuffixConst.DLNA_FILE_NAME_EXT_AAC;
      }
      else if (mimeType.equals(FileSuffixConst.DLNA_MEDIA_MIME_TYPE_AUDIO_VND_DOLBY_DD_RAW)) {
        return FileSuffixConst.DLNA_FILE_NAME_EXT_AC3;
      }
  ...
  public boolean equals(DLNAFile fileIns) {
    ...
    if (type == TYPE_DEVICE) {
      ...
      if (this.getContent().getTitle() == null || this.getContent().getTitle() == null
          || fileIns.getContent() == null)
        return false;
      if (this.getContent().getObjectId().equals(fileIns.getContent()
          .getObjectId()))
        return true;
    }
    return false;
