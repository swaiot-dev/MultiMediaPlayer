...
public class VideoConst {
	...
	public static final int PLAY_STATUS_STARTING = 3;
	public static final int PLAY_STATUS_STARTED = 4;
	public static final int PLAY_STATUS_PAUSED = 5;
	public static final int PLAY_STATUS_FF = 6;
	public static final int PLAY_STATUS_FR = 7;
	public static final int PLAY_STATUS_SF = 8;
	public static final int PLAY_STATUS_SR = 9;
	public static final int PLAY_STATUS_SEEKING = 10;
	public static final int PLAY_STATUS_STEP = 11;
	public static final int PLAY_STATUS_STOPPED = 12;
	...
	//DRM
	public static final int DIVX_DRM_RENTAL           =    (1 << 0);
	public static final int DIVX_DRM_RENTAL_EXPIRED   =    (1 << 1);
	public static final int DIVX_DRM_AUTH_ERROR       =    (1 << 2);
