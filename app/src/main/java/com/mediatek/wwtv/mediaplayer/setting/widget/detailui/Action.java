...
package com.mediatek.wwtv.mediaplayer.setting.widget.detailui;
...
public class Action implements Parcelable {
 ...
 // A cascade effect, a subclass of reference data kept the father
    ...
    public static HashMap<String, String[]> mHashMapForMax = new HashMap<String, String[]>();
    ...
    public Action(String mItemID, String mName, int mStartValue,
         ...
         if (mItemID.startsWith(com.mediatek.wwtv.mediaplayer.setting.util.MenuConfigManager.PARENTAL_OPEN_VCHIP_LEVEL)){
         ...
         if (mItemID.equals(MenuConfigManager.TIME_END_TIME) || mItemID.equals(MenuConfigManager.TIME_END_DATE) ||
                 mItemID.equals(MenuConfigManager.TIME_START_DATE) ||mItemID.equals(MenuConfigManager.TIME_START_TIME)) {
