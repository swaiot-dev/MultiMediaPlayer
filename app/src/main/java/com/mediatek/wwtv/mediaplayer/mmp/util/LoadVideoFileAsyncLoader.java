...
public class LoadVideoFileAsyncLoader<Result> {

    private final ArrayList<WorkItem<Result>> mQueue = new ArrayList<WorkItem<Result>>();

    private static LoadVideoFileAsyncLoader mAsyncLoader = null;
    ...
    public static LoadVideoFileAsyncLoader getInstance(int num) {

        if (mAsyncLoader == null) {
            mAsyncLoader = new LoadVideoFileAsyncLoader("PreFileThread");
        }
        return mAsyncLoader;
    }
    ...
    public LoadVideoFileAsyncLoader(String name) {
