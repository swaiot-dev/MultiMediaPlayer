...
import com.mediatek.wwtv.mediaplayer.setting.widget.view.BitmapDownloader;
import com.mediatek.wwtv.mediaplayer.setting.widget.view.BitmapDownloader.BitmapCallback;
import com.mediatek.wwtv.mediaplayer.setting.widget.view.BitmapWorkerOptions;
import com.mediatek.wwtv.mediaplayer.setting.widget.view.FrameLayoutWithShadows;
...
public class BaseContentFragment {
    ...
    public View onCreateView(
        ...
        if (Util.mIsDolbyVision){
            view = inflater.inflate(R.layout.content_fragment_dolby_vision, container, false);
        } else {
